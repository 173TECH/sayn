    ...
    assert result.is_ok and result.value == {
        "columns": [
            ...
            },
            {
                ...
                "dst_name": None,
                "allowed_values": False,
                "tests": [{"type": "unique", "allowed_values": [], "execute": True}],
            },
        ],
        "properties": [],
        "post_hook": [],
        ...
        "columns": [
            {
                ...
                "dst_name": None,
                "allowed_values": False,
                "tests": [{"type": "not_null", "allowed_values": [], "execute": True}],
            },
            {
                "name": "col2",
                "type": "BIGINT",
        ...
        "columns": [
            {
                ...
                "allowed_values": False,
                "tests": [
                    {"type": "not_null", "allowed_values": [], "execute": True},
                    {"type": "unique", "allowed_values": [], "execute": True},
                ],
            },
            {
                "name": "col2",
